          ...
          <div class="max-w-md mx-auto px-4 py-8">
            ...
            <form>
              ...
              <div class="flex items-center justify-between mt-6">
                <div class="mr-1">
                  <router-link class="text-sm underline hover:no-underline" to="/reset-password">¿Olvidó su contraseña?</router-link>
                </div>
            ...
            <div class="pt-5 mt-6 border-t border-slate-200">
              <div class="text-sm w-full text-left">
                ¿Aún no está suscrito? <router-link class="font-medium text-indigo-500 hover:text-indigo-600" to="/register">
                Suscribirse
                </router-link>
              </div>
