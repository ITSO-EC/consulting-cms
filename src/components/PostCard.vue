...
<template>
  ...
  <div class="w-auto sm:w-5/6 mx-2 sm:px-0 sm:mx-auto shadow-xl rounded-sm border border-gray-200">
    <div class="grid grid-cols-12 w-full">
      ...
      <div class="col-span-12 sm:col-span-6 lg:col-span-8">
        <div class="grid grid-cols-2 lg:grid-cols-4 p-4">
          <span :class="`text-[${primaryColor}] col-span-2 lg:col-span-4 font-bold text-left`">Reforma en la declaracion de IVA</span>
          <span :class="`text-[${primaryColor}] font-bold text-left`">R.O.:</span>
          <span class="text-justify">9123</span>
    ...
    <div class="col-span-12 min-h-40 h-auto px-2 text-left mx-4 py-4 border-t border-gray-200">
      ...
      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eaque animi eos, provident autem doloribus magni ut voluptate facere quibusdam dolorum totam vitae. Iste quam temporibus ad ea quod aliquid itaque.
    </div>
