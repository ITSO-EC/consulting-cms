...
<template>
    <div class="mt-20 w-5/6 mx-auto grid grid-cols-3 border">
        ...
        <div class="flex items-center gap-4 border-t border-b border-l p-2 ">
            <h1 class="text-indigo-600 text-2xl font-bold">
                Titulo de ejemplo
            </h1>
        </div>
        
        <div class="flex items-center gap-4  p-2">
            <button class="underline text-indigo-600 text-xl font-bold ">
                Descargar PDF
            </button>
        </div>
        ...
        <div class="flex items-center text-justify gap-4 border p-2 col-span-3" :class="showMore">
            ...
            <a href="#" class="text-blue-500 hover:underline">www.sri.gob.ec</a>
        </div>
