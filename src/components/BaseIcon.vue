...
<template>
  <div :class="getRounded">
    ...
    <svg
      ...
      style="enable-background: new 0 0 303.188 303.188"
      xml:space="preserve"
    >
      <g>
        <polygon
  ...
  v-if="props.name == 'printer'"
  fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="getStyle">
  ...
  <svg 
  v-if="props.name == 'download'"
  xmlns="http://www.w3.org/2000/svg" fill="none" 
  viewBox="0 0 24 24" stroke-width="1.5" 
  stroke="currentColor" :class="getStyle">
