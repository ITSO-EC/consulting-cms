...
<template>
  <div class="h-[50vh] relative flex justify-center -mt-16">
    ...
    class="absolute bottom-0 mx-auto backdrop-blur-2xl rounded-t-lg w-fit flex flex-col gap-4 px-2 sm:px-8 py-4 text-left z-10">
      <div>
        <h1 :class="`text-[${blankColor}]`" class="text-center brightness-150 text-4xl mb-1">
          Marco Legal Teorico
        </h1>
        <h2
        :class="`text-blue-500 font-semibold`" 
        class=" text-center text-xl mb-2">
