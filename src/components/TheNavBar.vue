...
<template>
  <nav :class="(scrolled || /^profile*/.test($route.name)|| /^search*/.test($route.name))? `bg-[${primaryColor}] shadow-lg` : `bg-none  border-gray-200 `" class="transition duration-300 px-4 lg:px-6 py-2.5">
